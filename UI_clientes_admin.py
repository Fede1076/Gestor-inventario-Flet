...
class AppForm(UserControl):
    ...
    def build(self):
        ...
        self.nombre_cliente_field = TextField(hint_text="Cliente")
        self.contraseña_field = TextField(hint_text="Contraseña")
        ...
        return Container(
            ...
            content=Column(
                ...
                controls=[
                    ...
                    Row(
                        controls=[
                            self.app_form_input_field("Nombre de cliente", 3),
                            self.app_form_input_field("Dirección", 1),
                        ],
                    ),
                    Row(
...
def add_to_db(self, e):
        ...
        nombre_cliente = self.nombre_cliente_field.value
        ...
        coleccion.insert_one(nuevo_cliente)
        ...
        return Row(
            ...
            controls=[
                DataTable(
                    ...
                    columns=[
                        DataColumn(
                            Text("Cliente", size=12, color='black', weight='bold')
                        ),
                        DataColumn(
                            Text("Dirección", size=12, color='black', weight='bold')
                        ),
                    ],
                    rows=[]
                )
